...
export const exhibitions: Exhibition[] = [
  ...
  },
  {
    ...
    description:
      'A group exhibition featuring Ukrainian artists in Spain — Viktoria Paladios presented new works from the Ukrainian Motifs series alongside fellow creatives.',
