...
export function madeToOrderText(artwork: Artwork): string {
  ...
  return `This is an original handmade painting by Pidlypna. A new original can also be created for you in this exact style and palette. While the composition remains consistent, each brushstroke is unique, ensuring your piece is a one-of-a-kind original with its own distinct character.`;
}
...
const DESCRIPTIONS: Record<string, string> = {
  ...
  'abstract-art-05':
    'Patina Horizon is an original mixed-media painting by Pidlypna celebrating the meeting of metal and landscape through copper texture and teal water. A dark ridge holds the light like a shoreline of memory. The work transforms an abstract horizon into a quiet contemporary piece that evokes depth, time, and refined calm.',
  'abstract-art-06':
    'Soft Current is an original acrylic painting by Pidlypna celebrating movement through mint, rose, and white in airy, layered strokes. Color travels across the canvas like water finding its path. The composition becomes a poetic contemporary work that evokes ease, breath, and gentle sophistication.',
  'abstract-art-07':
    'Vertical Light is an original acrylic painting by Pidlypna celebrating ascent through blue, white, and earth tones stacked like architecture. Light rises in measured strokes, as if a window were opening from within the paint. The work transforms abstraction into a contemporary meditation on hope, structure, and quiet lift.',
  'affirmation-collection-01':
    'Soy Fuerte is an original acrylic painting by Pidlypna celebrating inner strength through stylized waves and hand-lettered words. The sea carries the phrase like a vow, each crest painted with confident, contemporary rhythm. The composition becomes a poetic artwork of courage, devotion, and calm power.',
  'affirmation-collection-02':
    'Shine · Love · Create is an original mixed-media painting by Pidlypna celebrating a life motto written in Ukrainian — Сяй, Кохай, Твори — across soft pink light. The words rest inside the color as if they had always belonged there. The work transforms language into a contemporary symbol of joy, devotion, and making.',
  'affirmation-collection-03':
    'Joy is an original acrylic painting by Pidlypna celebrating gladness through a pale blue sky and clouds of lavender and peach. The word itself is painted into the atmosphere, light and unforced. The composition becomes a poetic contemporary piece that evokes serenity, warmth, and quiet happiness.',
  'affirmation-collection-04':
    'Bloom Anyway is an original acrylic painting by Pidlypna celebrating resilience through pink lettering across swirling blue and plum light. The words insist on beauty even when the season is difficult. The work transforms an affirmation into a contemporary painting of hope, tenderness, and strength.',
  'alcohol-ink-art-01':
    'Pastel Hills is an original alcohol-ink painting by Pidlypna celebrating landscape as breath through rose, lavender, and yellow veils. Ink is allowed to travel, bloom, and settle into hills that feel remembered rather than mapped. The composition becomes a poetic contemporary work that evokes softness, distance, and calm.',
  'alcohol-ink-art-02':
    'Soft Terrain is an original alcohol-ink painting by Pidlypna celebrating dusk through a pink sky over dark rolling ground. Fluid color finds its own edges, as evening does. The work transforms landscape into a contemporary meditation on quiet, warmth, and the end of day.',
  'alcohol-ink-art-03':
    'Ink Circle is an original alcohol-ink painting by Pidlypna celebrating completeness through a luminous ring of pink, lavender, indigo, and gold. Color gathers toward the center like a held secret. The composition becomes a poetic contemporary piece that evokes harmony, intimacy, and refined calm.',
  'alcohol-ink-art-04':
    'Ink Study I is an original alcohol-ink painting by Pidlypna celebrating chance and control as color is invited to bloom and settle. Each tide of pigment leaves a shoreline of its own. The work transforms a studio study into a contemporary artwork of curiosity, grace, and quiet experiment.',
  'alcohol-ink-art-05':
    'Blush Horizon is an original alcohol-ink painting by Pidlypna celebrating a circular landscape through blush sky and olive hills. Ink layers build distance without hard lines. The composition becomes a poetic contemporary work that evokes memory, softness, and open air.',
  'alcohol-ink-art-06':
    'Lavender Tide is an original alcohol-ink painting by Pidlypna celebrating flow through dusty rose and sky blue moving in a circular field. Veins of color travel like water under light. The work transforms fluid technique into a contemporary piece of serenity, romance, and quiet sophistication.',
  'female-portraits-01':
  ...
  'petrykivka-01':
    'Kalyna Night is an original Petrykivka painting by Pidlypna celebrating the kalyna berry as a living emblem of home. White fruit and leaves bloom against deep burgundy in traditional brushstrokes made contemporary. The work becomes a poetic symbol of memory, devotion, and Ukrainian beauty.',
  'petrykivka-02':
    'Blue Bloom is an original Petrykivka painting by Pidlypna celebrating a single flower opening against black, edged with orange leaves that catch the light. Classic strokes are placed with contemporary confidence. The composition evokes elegance, focus, and quiet festivity.',
  'petrykivka-03':
    'Blue & Gold is an original Petrykivka painting by Pidlypna celebrating an intimate floral sprig in Ukraine’s colors. The small format feels almost calligraphic — a note written in blossom. The work becomes a poetic contemporary piece of delicacy, heritage, and charm.',
  'petrykivka-04':
    'Golden Petals is an original Petrykivka painting by Pidlypna celebrating gold petal strokes among blue leaves and berry trails. Traditional rhythm meets a luminous, contemporary palette. The composition evokes celebration, craft, and the warmth of remembered gardens.',
  'petrykivka-05':
    'Teal Peonies is an original Petrykivka painting by Pidlypna celebrating spring through teal and burgundy flowers on a white ground. Each petal is placed with the light, airy touch of the tradition. The work becomes a poetic contemporary bloom of freshness, grace, and joy.',
  'petrykivka-06':
    'Red Berry Vine is an original Petrykivka painting by Pidlypna celebrating a tall climb of red blossoms, green leaves, and blue berries. The narrow format is read slowly, like a path through summer. The composition evokes abundance, craftsmanship, and quiet delight.',
  'petrykivka-07':
    'Garden Path is an original Petrykivka painting by Pidlypna celebrating orange and blue flowers winding upward along a green stem. Classic strokes keep the movement lively and precise. The work becomes a poetic contemporary piece of growth, color, and folk elegance.',
  'petrykivka-08':
    'Firebird is an original Petrykivka painting by Pidlypna celebrating the mythical bird rising from a black ground among ornamental florals. Tradition and story meet in a single, vivid form. The composition evokes wonder, heritage, and luminous courage.',
  'petrykivka-09':
    'Flame Sprig is an original Petrykivka painting by Pidlypna celebrating three flame-red flowers along a vertical stem with berries and leaves. The tall format feels like a bookmark of summer. The work becomes a poetic contemporary piece of warmth, rhythm, and craft.',
  'petrykivka-10':
  ...
  'textured-and-light-01':
    'Halo is an original mixed-media diptych by Pidlypna celebrating wholeness through a white and gold circle spanning two panels. Concentric textured lines build a quiet radiance where the canvases meet. The work becomes a poetic contemporary symbol of connection, light, and two places becoming one.',
  'textured-and-light-02':
    'Gold Arcs is an original mixed-media painting by Pidlypna celebrating quiet architecture through textured metallic arcs on clean white ground. Each curve is built in relief, catching real light as you move. The composition evokes elegance, space, and refined calm.',
