...
export const artworkDescriptions: Record<Language, Record<string, string>> = {
  en: {
    ...
    'alcohol-ink-art-02':
      'This work is an original alcohol-ink painting that celebrates dusk through a pink sky over dark rolling ground. Fluid color finds its own edges, as evening does. The work transforms landscape into a contemporary meditation on quiet, warmth, and the end of day.',
    'alcohol-ink-art-03':
      'This work is an original alcohol-ink painting that celebrates completeness through a luminous ring of pink, lavender, indigo, and gold. Color gathers toward the center like a held secret. The composition becomes a poetic contemporary piece that evokes harmony, intimacy, and refined calm.',
    'alcohol-ink-art-04':
      'This work is an original alcohol-ink painting that celebrates chance and control as color is invited to bloom and settle. Each tide of pigment leaves a shoreline of its own. The work transforms a studio study into a contemporary artwork of curiosity, grace, and quiet experiment.',
    'alcohol-ink-art-05':
      'This work is an original alcohol-ink painting that celebrates a circular landscape through blush sky and olive hills. Ink layers build distance without hard lines. The composition becomes a poetic contemporary work that evokes memory, softness, and open air.',
    'alcohol-ink-art-06':
      'This work is an original alcohol-ink painting that celebrates flow through dusty rose and sky blue moving in a circular field. Veins of color travel like water under light. The work transforms fluid technique into a contemporary piece of serenity, romance, and quiet sophistication.',
    'female-portraits-01':
    ...
    'plain-air-collection-04':
      'This work is an original acrylic painting that celebrates a walk through flowering trees toward far mountains. Spring light is arranged in rows, as if the path itself were blooming. The composition evokes hope, journey, and quiet joy.',
    'pop-art-01':
    ...
    'textured-and-light-02':
      'This work is an original mixed-media painting that celebrates quiet architecture through textured metallic arcs on clean white ground. Each curve is built in relief, catching real light as you move. The composition evokes elegance, space, and refined calm.',
  ...
  es: {
    ...
    'alcohol-ink-art-02':
      'Esta obra es una pintura original en tinta alcohólica que celebra el crepúsculo con un cielo rosa sobre un suelo ondulado y oscuro. El color fluido encuentra sus propios bordes, como lo hace la noche. La obra transforma el paisaje en una meditación contemporánea sobre la quietud, el calor y el final del día.',
    'alcohol-ink-art-03':
      'Esta obra es una pintura original en tinta alcohólica que celebra la plenitud mediante un anillo luminoso de rosa, lavanda, índigo y oro. El color se congrega hacia el centro como un secreto guardado. La composición se convierte en una pieza contemporánea poética de armonía, intimidad y calma refinada.',
    'alcohol-ink-art-04':
      'Esta obra es una pintura original en tinta alcohólica que celebra el azar y el control cuando se invita al color a florecer y asentarse. Cada marea de pigmento deja su propia orilla. La obra transforma un estudio de taller en una pieza contemporánea de curiosidad, gracia y experimento silencioso.',
    'alcohol-ink-art-05':
      'Esta obra es una pintura original en tinta alcohólica que celebra un paisaje circular con cielo sonrosado y colinas oliva. Las capas de tinta construyen distancia sin líneas duras. La composición se convierte en una obra contemporánea poética que evoca memoria, suavidad y aire abierto.',
    'alcohol-ink-art-06':
      'Esta obra es una pintura original en tinta alcohólica que celebra el flujo mediante rosa polvoriento y azul cielo en un campo circular. Las venas de color viajan como agua bajo la luz. La obra transforma la técnica fluida en una pieza contemporánea de serenidad, romanticismo y sofisticación discreta.',
    'female-portraits-01':
    ...
    'textured-and-light-02':
      'Esta obra es una pintura de técnica mixta original que celebra una arquitectura quieta mediante arcos metálicos texturizados sobre fondo blanco limpio. Cada curva se construye en relieve y captura la luz real al moverte. La composición evoca elegancia, espacio y calma refinada.',
    'textured-and-light-03':
  ...
  uk: {
    ...
    'alcohol-ink-art-02':
      'Ця робота оспівує сутінки через рожеве небо над темною хвилястою землею. Плинний колір знаходить власні краї, як і вечір. Робота перетворює пейзаж на сучасну медитацію про тишу, тепло й кінець дня.',
    'alcohol-ink-art-03':
      'Ця робота оспівує цілісність через світле кільце рожевого, лавандового, індиго та золота. Колір збирається до центру, мов збережена таємниця. Композиція стає поетичним сучасним твором про гармонію, близькість і витончений спокій.',
    'alcohol-ink-art-04':
      'Ця робота оспівує випадок і контроль, коли колір запрошують розквітати й осідати. Кожна хвиля пігменту лишає свій берег. Робота перетворює студійне дослідження на сучасний твір цікавості, грації й тихого експерименту.',
    'alcohol-ink-art-05':
      'Ця робота оспівує круглий пейзаж через рум’яне небо та оливкові пагорби. Шари чорнила будують відстань без жорстких ліній. Композиція стає поетичною сучасною роботою про пам’ять, м’якість і відкрите повітря.',
    'alcohol-ink-art-06':
      'Ця робота оспівує плинність через припорошений рожевий і небесно-блакитний у круглому полі. Жили кольору йдуть, як вода під світлом. Робота перетворює плинну техніку на сучасний твір спокою, романтики й стриманої витонченості.',
    'female-portraits-01':
      'Ця робота у змішаній техніці оспівує тиху силу жінки через графічний профіль та пишну скульптурну корону з квітів. Густі пелюстки імпасто в білих, рожевих, маджентових і зелених відтінках розквітають над обличчям, а неонові акценти й зелені геометричні блоки додають сучасного звучання. Композиція перетворює портрет на поетичний символ ідентичності, краси й внутрішнього розквіту.',
    'female-portraits-02':
      'Ця робота оспівує жінку, яка зливається з морем і небом. Приплив, горизонт і фігура ділять один подих, написані шаруватим світлим кольором. Робота стає поетичним сучасним портретом належності, свободи й тихої трансформації.',
    'female-portraits-03':
    ...
    'textured-and-light-01':
      'Ця робота оспівує цілісність через біло-золоте коло на двох панелях. Концентричні фактурні лінії будують тихе сяйво там, де полотна зустрічаються. Робота стає поетичним сучасним символом зв’язку, світла й двох місць, що стають одним.',
    'textured-and-light-02':
      'Ця робота оспівує тиху архітектуру через фактурні металеві дуги на чистому білому тлі. Кожна крива побудована рельєфом і ловить справжнє світло, коли ви рухаєтесь. Композиція викликає елегантність, простір і витончений спокій.',
    'textured-and-light-03':
      'Ця робота оспівує солодкість і свято через персиковий торт із трояндами та полуницею, побудований густою світлою фарбою. Глазур і пелюстки ділять ту саму скульптурну радість. Робота стає поетичним сучасним натюрмортом насолоди, турботи й святковості.',
    'ukrainian-symbolism-01':
      'Ця робота оспівує обличчя, вплетене в українську вишивку — пам’ять, утримана в шкірі. Реалізм і народний орнамент ділять один портрет, ніби минуле все ще говорить. Композиція стає поетичною сучасною роботою про ідентичність, відданість і належність.',
  },
};
