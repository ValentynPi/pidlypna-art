...
export const artworkDescriptions: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    'affirmation-collection-01':
      'Soy Fuerte es una pintura acrílica original de Viktoria Paladios que celebra la fuerza interior mediante olas estilizadas y palabras escritas a mano. El mar lleva la frase como un voto; cada cresta está pintada con ritmo contemporáneo y seguro. La composición se convierte en una obra poética de valor, devoción y poder sereno.',
    'affirmation-collection-02':
      'Shine · Love · Create es una pintura de técnica mixta original de Viktoria Paladios que celebra un lema de vida escrito en ucraniano — Сяй, Кохай, Твори — sobre una luz rosa suave. Las palabras descansan en el color como si siempre hubieran pertenecido allí. La obra transforma el lenguaje en un símbolo contemporáneo de alegría, devoción y creación.',
    'affirmation-collection-03':
      'Joy es una pintura acrílica original de Viktoria Paladios que celebra la alegría a través de un cielo azul pálido y nubes de lavanda y melocotón. La palabra misma está pintada en la atmósfera, ligera y sin forzar. La composición se convierte en una pieza contemporánea poética que evoca serenidad, calidez y felicidad quieta.',
    'affirmation-collection-04':
      'Bloom Anyway es una pintura acrílica original de Viktoria Paladios que celebra la resiliencia con tipografía rosa sobre luz azul y ciruela en remolino. Las palabras insisten en la belleza incluso cuando la estación es difícil. La obra transforma una afirmación en una pintura contemporánea de esperanza, ternura y fuerza.',
    'alcohol-ink-art-01':
      'Pastel Hills es una pintura original en tinta alcohólica de Viktoria Paladios que celebra el paisaje como respiración mediante velos de rosa, lavanda y amarillo. La tinta viaja, florece y se asienta en colinas que se sienten recordadas más que cartografiadas. La composición se convierte en una obra contemporánea poética de suavidad, distancia y calma.',
    'alcohol-ink-art-02':
      'Soft Terrain es una pintura original en tinta alcohólica de Viktoria Paladios que celebra el crepúsculo con un cielo rosa sobre un suelo ondulado y oscuro. El color fluido encuentra sus propios bordes, como lo hace la noche. La obra transforma el paisaje en una meditación contemporánea sobre la quietud, el calor y el final del día.',
    'alcohol-ink-art-03':
      'Ink Circle es una pintura original en tinta alcohólica de Viktoria Paladios que celebra la plenitud mediante un anillo luminoso de rosa, lavanda, índigo y oro. El color se congrega hacia el centro como un secreto guardado. La composición se convierte en una pieza contemporánea poética de armonía, intimidad y calma refinada.',
    'alcohol-ink-art-04':
      'Ink Study I es una pintura original en tinta alcohólica de Viktoria Paladios que celebra el azar y el control cuando se invita al color a florecer y asentarse. Cada marea de pigmento deja su propia orilla. La obra transforma un estudio de taller en una pieza contemporánea de curiosidad, gracia y experimento silencioso.',
    'alcohol-ink-art-05':
      'Blush Horizon es una pintura original en tinta alcohólica de Viktoria Paladios que celebra un paisaje circular con cielo sonrosado y colinas oliva. Las capas de tinta construyen distancia sin líneas duras. La composición se convierte en una obra contemporánea poética que evoca memoria, suavidad y aire abierto.',
    'alcohol-ink-art-06':
    ...
    'floral-collection-02':
      'White Lilacs es una pintura acrílica original de Viktoria Paladios que celebra perfume y memoria con flores blancas en cristal sobre un burdeos profundo. Racimos delicados se construyen con trazos pacientes y luminosos. La obra transforma un bodegón en una meditación contemporánea sobre la ternura, el hogar y el lujo discreto.',
    'floral-collection-03':
    ...
    'petrykivka-02':
      'Blue Bloom es una pintura Petrykivka original de Viktoria Paladios que celebra una sola flor abriéndose sobre negro, bordeada de hojas naranjas que captan la luz. Los trazos clásicos se colocan con confianza contemporánea. La composición evoca elegancia, foco y festividad silenciosa.',
    'petrykivka-03':
      'Blue & Gold es una pintura Petrykivka original de Viktoria Paladios que celebra un ramito floral íntimo en los colores de Ucrania. El formato pequeño se siente casi caligráfico: una nota escrita en flor. La obra se convierte en una pieza contemporánea poética de delicadeza, herencia y encanto.',
    'petrykivka-04':
      'Golden Petals es una pintura Petrykivka original de Viktoria Paladios que celebra trazos de pétalos dorados entre hojas azules y senderos de bayas. El ritmo tradicional encuentra una paleta luminosa y contemporánea. La composición evoca celebración, oficio y el calor de jardines recordados.',
    'petrykivka-05':
      'Teal Peonies es una pintura Petrykivka original de Viktoria Paladios que celebra la primavera con flores verdeazuladas y burdeos sobre fondo blanco. Cada pétalo se coloca con el toque ligero y aéreo de la tradición. La obra se convierte en una flor contemporánea poética de frescura, gracia y alegría.',
    'petrykivka-06':
      'Red Berry Vine es una pintura Petrykivka original de Viktoria Paladios que celebra una alta trepadora de flores rojas, hojas verdes y bayas azules. El formato estrecho se lee despacio, como un camino por el verano. La composición evoca abundancia, maestría y deleite silencioso.',
    'petrykivka-07':
      'Garden Path es una pintura Petrykivka original de Viktoria Paladios que celebra flores naranjas y azules que ascienden por un tallo verde. Los trazos clásicos mantienen el movimiento vivo y preciso. La obra se convierte en una pieza contemporánea poética de crecimiento, color y elegancia popular.',
    'petrykivka-08':
      'Firebird es una pintura Petrykivka original de Viktoria Paladios que celebra el ave mítica surgiendo de un fondo negro entre florales ornamentales. Tradición e historia se encuentran en una sola forma vivida. La composición evoca asombro, herencia y valor luminoso.',
    'petrykivka-09':
      'Flame Sprig es una pintura Petrykivka original de Viktoria Paladios que celebra tres flores rojo fuego a lo largo de un tallo vertical con bayas y hojas. El formato alto se siente como un marcador del verano. La obra se convierte en una pieza contemporánea poética de calor, ritmo y oficio.',
    'petrykivka-10':
      'Spiral Garden es una pintura Petrykivka original de Viktoria Paladios que celebra motivos florales abriéndose hacia fuera en un lienzo redondo. Una paleta más quieta, casi monocroma, deja que el ritmo de los trazos lidere. La composición evoca meditación, equilibrio y belleza popular refinada.',
    'plain-air-collection-01':
      'Snow Peaks es una pintura acrílica original de Viktoria Paladios que celebra la lejanía elevada mediante un cielo azul pálido y nieve serena. Las montañas se sostienen con color claro y calmado, sin ruido. La obra se convierte en un paisaje contemporáneo poético de quietud, aire y asombro.',
    'plain-air-collection-02':
      'Plein Air II es una pintura acrílica original de Viktoria Paladios que celebra pintar en el lugar: el color como respuesta inmediata a la luz. Los trazos frescos mantienen la hora visible en el lienzo. La composición evoca presencia, clima y el placer de mirar.',
    'plain-air-collection-03':
      'Lavender Fields es una pintura acrílica original de Viktoria Paladios que celebra filas púrpura que llevan hacia tierra dorada y montañas lejanas. El paisaje es lugar y perfume, pintado con calor mediterráneo. La obra se convierte en una pieza contemporánea poética de viaje, calma y luz de verano.',
    'plain-air-collection-04':
    ...
    'textured-and-light-01':
      'Halo es un díptico de técnica mixta original de Viktoria Paladios que celebra la plenitud mediante un círculo blanco y dorado que abarca dos paneles. Líneas texturizadas concéntricas construyen un resplandor sereno donde se encuentran los lienzos. La obra se convierte en un símbolo contemporáneo poético de conexión, luz y dos lugares que se hacen uno.',
    'textured-and-light-02':
      'Gold Arcs es una pintura de técnica mixta original de Viktoria Paladios que celebra una arquitectura quieta mediante arcos metálicos texturizados sobre fondo blanco limpio. Cada curva se construye en relieve y captura la luz real al moverte. La composición evoca elegancia, espacio y calma refinada.',
    'textured-and-light-03':
  ...
  uk: {
    ...
    'affirmation-collection-01':
      'Soy Fuerte — оригінальна акрилова картина Вікторії Паладіос, що оспівує внутрішню силу через стилізовані хвилі та рукописні слова. Море несе фразу, мов обітницю; кожен гребінь написаний упевненим сучасним ритмом. Композиція стає поетичним твором про мужність, відданість і спокійну силу.',
    'affirmation-collection-02':
      'Shine · Love · Create — оригінальна картина в змішаній техніці Вікторії Паладіос, що оспівує життєве гасло українською — Сяй, Кохай, Твори — на м’якому рожевому світлі. Слова лежать у кольорі так, ніби завжди там були. Робота перетворює мову на сучасний символ радості, відданості та творення.',
    'affirmation-collection-03':
      'Joy — оригінальна акрилова картина Вікторії Паладіос, що оспівує радість через блідо-блакитне небо та хмари лаванди й персика. Саме слово вписане в атмосферу — легко й невимушено. Композиція стає поетичним сучасним твором про спокій, тепло й тихе щастя.',
    'affirmation-collection-04':
      'Bloom Anyway — оригінальна акрилова картина Вікторії Паладіос, що оспівує стійкість через рожевий напис на круговерті синього й сливового світла. Слова наполягають на красі навіть у складну пору. Робота перетворює афірмацію на сучасний живопис надії, ніжності й сили.',
    'alcohol-ink-art-01':
      'Pastel Hills — оригінальна картина спиртовими чорнилами Вікторії Паладіос, що оспівує пейзаж як подих через рожеві, лавандові та жовті вуалі. Чорнилу дають текти, розквітати й осідати в пагорби, які відчуваються згаданими, а не накресленими. Композиція стає поетичною сучасною роботою про м’якість, відстань і спокій.',
    'alcohol-ink-art-02':
      'Soft Terrain — оригінальна картина спиртовими чорнилами Вікторії Паладіос, що оспівує сутінки через рожеве небо над темною хвилястою землею. Плинний колір знаходить власні краї, як і вечір. Робота перетворює пейзаж на сучасну медитацію про тишу, тепло й кінець дня.',
    'alcohol-ink-art-03':
      'Ink Circle — оригінальна картина спиртовими чорнилами Вікторії Паладіос, що оспівує цілісність через світле кільце рожевого, лавандового, індиго та золота. Колір збирається до центру, мов збережена таємниця. Композиція стає поетичним сучасним твором про гармонію, близькість і витончений спокій.',
    'alcohol-ink-art-04':
      'Ink Study I — оригінальна картина спиртовими чорнилами Вікторії Паладіос, що оспівує випадок і контроль, коли колір запрошують розквітати й осідати. Кожна хвиля пігменту лишає свій берег. Робота перетворює студійне дослідження на сучасний твір цікавості, грації й тихого експерименту.',
    'alcohol-ink-art-05':
      'Blush Horizon — оригінальна картина спиртовими чорнилами Вікторії Паладіос, що оспівує круглий пейзаж через рум’яне небо та оливкові пагорби. Шари чорнила будують відстань без жорстких ліній. Композиція стає поетичною сучасною роботою про пам’ять, м’якість і відкрите повітря.',
    'alcohol-ink-art-06':
    ...
    'floral-collection-02':
      'White Lilacs — оригінальна акрилова картина Вікторії Паладіос, що оспівує аромат і пам’ять через білі суцвіття в склі на глибокому бордовому тлі. Делікатні грона побудовані терплячими світлими мазками. Робота перетворює натюрморт на сучасну медитацію про ніжність, дім і тиху розкіш.',
    'floral-collection-03':
    ...
    'petrykivka-02':
      'Blue Bloom — оригінальний петриківський розпис Вікторії Паладіос, що оспівує одну квітку, яка розкривається на чорному тлі, обрамлену помаранчевим листям, що ловить світло. Класичні мазки поставлені з сучасною впевненістю. Композиція викликає відчуття елегантності, зосередженості й тихого свята.',
    'petrykivka-03':
      'Blue & Gold — оригінальний петриківський розпис Вікторії Паладіос, що оспівує інтимну квіткову гілочку в кольорах України. Малий формат майже каліграфічний — ніби нотатка, написана цвітом. Робота стає поетичним сучасним твором ніжності, спадщини й чарівності.',
    'petrykivka-04':
      'Golden Petals — оригінальний петриківський розпис Вікторії Паладіос, що оспівує золоті пелюсткові мазки серед синього листя й ягідних стежок. Традиційний ритм зустрічає світлу сучасну палітру. Композиція викликає відчуття свята, ремесла й тепла згаданих садів.',
    'petrykivka-05':
      'Teal Peonies — оригінальний петриківський розпис Вікторії Паладіос, що оспівує весну через бірюзові й бордові квіти на білому тлі. Кожна пелюстка поставлена легким повітряним дотиком традиції. Робота стає поетичним сучасним цвітінням свіжості, грації й радості.',
    'petrykivka-06':
      'Red Berry Vine — оригінальний петриківський розпис Вікторії Паладіос, що оспівує високий підйом червоних квітів, зеленого листя й синіх ягід. Вузький формат читається повільно, мов стежка крізь літо. Композиція викликає відчуття достатку, майстерності й тихої втіхи.',
    'petrykivka-07':
      'Garden Path — оригінальний петриківський розпис Вікторії Паладіос, що оспівує помаранчеві й сині квіти, які в’ються вгору зеленим стеблом. Класичні мазки тримають рух живим і точним. Робота стає поетичним сучасним твором зростання, кольору й народної елегантності.',
    'petrykivka-08':
      'Firebird — оригінальний петриківський розпис Вікторії Паладіос, що оспівує міфічного птаха, який піднімається з чорного тла серед орнаментальних квітів. Традиція й оповідь зустрічаються в одній яскравій формі. Композиція викликає подив, спадщину й світлу мужність.',
    'petrykivka-09':
      'Flame Sprig — оригінальний петриківський розпис Вікторії Паладіос, що оспівує три полум’яно-червоні квіти вздовж вертикального стебла з ягодами й листям. Високий формат відчувається як закладка літа. Робота стає поетичним сучасним твором тепла, ритму й ремесла.',
    'petrykivka-10':
      'Spiral Garden — оригінальний петриківський розпис Вікторії Паладіос, що оспівує квіткові мотиви, які розходяться на круглому полотні. Спокійніша, майже монохромна палітра дає вести ритму мазків. Композиція викликає медитацію, рівновагу й витончену народну красу.',
    'plain-air-collection-01':
      'Snow Peaks — оригінальна акрилова картина Вікторії Паладіос, що оспівує високу далечінь через блідо-блакитне небо й тихий сніг. Гори тримаються ясним спокійним кольором, без шуму. Робота стає поетичним сучасним пейзажем тиші, повітря й благоговіння.',
    'plain-air-collection-02':
      'Plein Air II — оригінальна акрилова картина Вікторії Паладіос, що оспівує живопис на пленері: колір як миттєва відповідь на світло. Свіжі мазки зберігають годину видимою на полотні. Композиція викликає присутність, погоду й радість дивитися.',
    'plain-air-collection-03':
      'Lavender Fields — оригінальна акрилова картина Вікторії Паладіос, що оспівує фіолетові ряди, які ведуть до золотої землі й далеких гір. Пейзаж — і місце, і аромат, написаний середземноморським теплом. Робота стає поетичним сучасним твором подорожі, спокою й літнього світла.',
    'plain-air-collection-04':
    ...
    'textured-and-light-01':
      'Halo — оригінальний диптих у змішаній техніці Вікторії Паладіос, що оспівує цілісність через біло-золоте коло на двох панелях. Концентричні фактурні лінії будують тихе сяйво там, де полотна зустрічаються. Робота стає поетичним сучасним символом зв’язку, світла й двох місць, що стають одним.',
    'textured-and-light-02':
      'Gold Arcs — оригінальна картина в змішаній техніці Вікторії Паладіос, що оспівує тиху архітектуру через фактурні металеві дуги на чистому білому тлі. Кожна крива побудована рельєфом і ловить справжнє світло, коли ви рухаєтесь. Композиція викликає елегантність, простір і витончений спокій.',
    'textured-and-light-03':
