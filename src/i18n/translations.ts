...
const en: TranslationTree = {
  ...
  gallery: {
    ...
    artworkNotFound: 'Painting not found',
  },
  workshops: {
    metaTitle: 'Workshops',
    metaDesc:
  ...
  lightbox: {
    ...
    techniqueAtmosphericLandscape: 'Atmospheric abstract landscape',
    techniqueAbstractSunset: 'Abstract sunset landscape',
    techniqueAbstractCityscape: 'Abstract cityscape',
    ...
    techniqueCircularFluidLandscape: 'Circular fluid landscape',
    techniquePortraitFloral: 'Portrait with floral headpiece',
    techniqueSurrealistPortrait: 'Surrealist portrait',
    techniqueFloralStillLife: 'Floral still life',
    techniqueTexturedFloralStillLife: 'Textured floral still life',
    techniqueLandscapeStudy: 'Landscape study',
    techniqueImaginativeLandscape: 'Imaginative landscape',
    techniqueMountainLandscape: 'Mountain landscape',
    techniquePleinAir: 'Plein air landscape',
    techniqueExpressivePortrait: 'Expressive color portrait',
    techniqueTexturedDiptych: 'Textured diptych',
    techniqueTexturedAbstract: 'Textured abstract composition',
    techniqueTexturedStillLife: 'Textured still life',
    techniquePortraitEmbroidery: 'Portrait with folk embroidery motifs',
...
const es: TranslationTree = {
  ...
  gallery: {
    ...
    artworkNotFound: 'Pintura no encontrada',
  },
  workshops: {
    metaTitle: 'Talleres',
    metaDesc:
  ...
  lightbox: {
    ...
    techniqueAtmosphericLandscape: 'Paisaje abstracto atmosférico',
    techniqueAbstractSunset: 'Paisaje abstracto de atardecer',
    techniqueAbstractCityscape: 'Paisaje urbano abstracto',
    ...
    techniqueCircularFluidLandscape: 'Paisaje fluido circular',
    techniquePortraitFloral: 'Retrato con tocado floral',
    techniqueSurrealistPortrait: 'Retrato surrealista',
    techniqueFloralStillLife: 'Bodegón floral',
    techniqueTexturedFloralStillLife: 'Bodegón floral texturizado',
    techniqueLandscapeStudy: 'Estudio de paisaje',
    techniqueImaginativeLandscape: 'Paisaje imaginativo',
    techniqueMountainLandscape: 'Paisaje de montaña',
    techniquePleinAir: 'Paisaje de plein air',
    techniqueExpressivePortrait: 'Retrato expresivo en color',
    techniqueTexturedDiptych: 'Díptico texturizado',
    techniqueTexturedAbstract: 'Composición abstracta texturizada',
    techniqueTexturedStillLife: 'Bodegón texturizado',
    techniquePortraitEmbroidery: 'Retrato con motivos de bordado popular',
...
const uk: TranslationTree = {
  ...
  gallery: {
    ...
    artworkNotFound: 'Картину не знайдено',
  },
  workshops: {
  ...
  lightbox: {
    ...
    techniqueAtmosphericLandscape: 'Атмосферний абстрактний пейзаж',
    techniqueAbstractSunset: 'Абстрактний пейзаж заходу сонця',
    techniqueAbstractCityscape: 'Абстрактний міський пейзаж',
    ...
    techniqueCircularFluidLandscape: 'Круглий плинний пейзаж',
    techniquePortraitFloral: 'Портрет із квітковим головним убором',
    techniqueSurrealistPortrait: 'Сюрреалістичний портрет',
    techniqueFloralStillLife: 'Квітковий натюрморт',
    techniqueTexturedFloralStillLife: 'Фактурний квітковий натюрморт',
    techniqueLandscapeStudy: 'Пейзажне дослідження',
    techniqueImaginativeLandscape: 'Уявний пейзаж',
    techniqueMountainLandscape: 'Гірський пейзаж',
    techniquePleinAir: 'Пейзаж на пленері',
    techniqueExpressivePortrait: 'Експресивний кольоровий портрет',
    techniqueTexturedDiptych: 'Фактурний диптих',
    techniqueTexturedAbstract: 'Фактурна абстрактна композиція',
    techniqueTexturedStillLife: 'Фактурний натюрморт',
    techniquePortraitEmbroidery: 'Портрет із мотивами народної вишивки',
